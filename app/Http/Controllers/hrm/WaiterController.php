...
class WaiterController extends Controller
{
    ...
    {
        $this->authorizeForUser($request->user('api'), 'create', Waiter::class);
    ...
    {
        $this->authorizeForUser($request->user('api'), 'update', Waiter::class);
    ...
    {
        $this->authorizeForUser($request->user('api'), 'delete', Waiter::class);
    ...
    public function delete_by_selection(Request $request)
    {
        ...
        foreach ($selectedIds as $holiday_id) {
            Waiter::whereId($holiday_id)->update([
                'deleted_at' => Carbon::now(),
            ]);
        }
