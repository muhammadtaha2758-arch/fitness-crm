...
class DepartmentCategoryController extends BaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $categories = DepartmentCategory::where('deleted_at', '=', null)
    ...
    public function update(Request $request, $id)
    {
        ...
        DepartmentCategory::whereId($id)->update([
            'code' => $request['code'],
            'name' => $request['name'],
        ]);
        return response()->json(['success' => true]);
    ...
    public function delete_by_selection(Request $request)
    {
        ...
        foreach ($selectedIds as $category_id) {
            DepartmentCategory::whereId($category_id)->update([
                'deleted_at' => Carbon::now(),
            ]);
        }
