        ...
        <div class="row">
          <div class="col-md-12">
            <div class="p-4">
              ...
              <h1 class="mb-3 text-18">Forgot_Password</h1>
              <validation-observer ref="Reset_password">
                <b-form @submit.prevent="Submit_Reset">
                  ...
                  >
                    <b-form-group :label="Email_Address" class="text-12">
                      <b-form-input
      ...
      axios
        ...
        .then(result => {
          ...
          if (result.data.status) {
            this.makeToast(
              "success",
              this.We_have_emailed_your_password_reset_link,
              this.Success
            );
        ...
        .catch(error => {
          this.makeToast(
            "danger",
            this.Failed_to_authenticate_on_SMTP_server,
            this.Failed
          );
          NProgress.done();
          this.loading = false;
