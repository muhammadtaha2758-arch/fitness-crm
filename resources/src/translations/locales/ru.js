...
export default {
    ...
    Support: 'Поддержка',
    'Workout Plan Library': 'Библиотека планов тренировок',
    'Activity List': 'Список активностей',
    'Send Message': 'Отправить сообщение',
    'Sent Messages': 'Отправленные сообщения',
    'Email / SMS / App Push Campaigns': 'Кампании Email / SMS / Push-уведомлений',
    'Automated Messages': 'Автоматические сообщения',
    'WhatsApp / In-App Chat Integration': 'Интеграция WhatsApp / чата в приложении',
    'Notifications Manager': 'Менеджер уведомлений',
    'Message Composer': 'Создатель сообщений',
    History: 'История',
    'Membership Plan': 'План членства',
    'Member Progress': 'Прогресс участника',
    'Attendance & Workout': 'Посещаемость и тренировка',
    'Nutrition Compliance Reports': 'Отчеты о соблюдении питания',
    'Revenue & Subscription Reports': 'Отчеты о доходах и подписках',
    'Coach Performance': 'Производительность тренера',
    'Challenge Completion Stats': 'Статистика завершения вызовов'
};