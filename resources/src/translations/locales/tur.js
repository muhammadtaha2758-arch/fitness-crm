...
export default {
    ...
    'Nutrition Hub': 'Beslenme Merkezi',
    Community: 'Topluluk',
    ...
    Support: 'Destek',
    'Workout Plan Library': 'Antrenman Planı Kütüphanesi',
    'Activity List': 'Aktivite Listesi',
    'Send Message': 'Mesaj Gönder',
    'Sent Messages': 'Gönderilen Mesajlar',
    'Email / SMS / App Push Campaigns': 'E-posta / SMS / Uygulama Push Kampanyaları',
    'Automated Messages': 'Otomatik Mesajlar',
    'WhatsApp / In-App Chat Integration': 'WhatsApp / Uygulama İçi Sohbet Entegrasyonu',
    'Notifications Manager': 'Bildirim Yöneticisi',
    'Message Composer': 'Mesaj Oluşturucu',
    History: 'Geçmiş',
    'Membership Plan': 'Üyelik Planı',
    'Member Progress': 'Üye İlerlemesi',
    'Attendance & Workout': 'Katılım ve Antrenman',
    'Nutrition Compliance Reports': 'Beslenme Uyum Raporları',
    'Revenue & Subscription Reports': 'Gelir ve Abonelik Raporları',
    'Coach Performance': 'Antrenör Performansı',
    'Challenge Completion Stats': 'Meydan Okuma Tamamlama İstatistikleri'
};