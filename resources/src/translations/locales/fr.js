...
export default {
    ...
    'Nutrition Hub': 'Centre de nutrition',
    ...
    Support: 'Support',
    'Workout Plan Library': 'Bibliothèque de plans d\'entraînement',
    'Activity List': 'Liste des activités',
    'Send Message': 'Envoyer un message',
    'Sent Messages': 'Messages envoyés',
    'Email / SMS / App Push Campaigns': 'Campagnes Email / SMS / Push',
    'Automated Messages': 'Messages automatisés',
    'WhatsApp / In-App Chat Integration': 'Intégration WhatsApp / Chat dans l\'app',
    'Notifications Manager': 'Gestionnaire de notifications',
    'Message Composer': 'Composeur de messages',
    History: 'Historique',
    'Membership Plan': 'Plan d\'adhésion',
    'Member Progress': 'Progrès du membre',
    'Attendance & Workout': 'Présence et entraînement',
    'Nutrition Compliance Reports': 'Rapports de conformité nutritionnelle',
    'Revenue & Subscription Reports': 'Rapports de revenus et d\'abonnements',
    'Coach Performance': 'Performance de l\'entraîneur',
    'Challenge Completion Stats': 'Statistiques de complétion des défis'
};