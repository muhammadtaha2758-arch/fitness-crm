...
export default {
    ...
    Challenges: 'التحديات',
    Workouts: 'التمارين',
    'Nutrition Hub': 'مركز التغذية',
    Community: 'المجتمع',
    'Business analytics': 'التحليلات التجارية',
    ...
    Support: 'الدعم',
    'Workout Plan Library': 'مكتبة خطط التمرين',
    'Activity List': 'قائمة الأنشطة',
    'Send Message': 'إرسال رسالة',
    'Sent Messages': 'الرسائل المرسلة',
    'Email / SMS / App Push Campaigns': 'حملات البريد الإلكتروني / الرسائل القصيرة / الإشعارات',
    'Automated Messages': 'الرسائل الآلية',
    'WhatsApp / In-App Chat Integration': 'تكامل واتساب / الدردشة داخل التطبيق',
    'Notifications Manager': 'مدير الإشعارات',
    'Message Composer': 'منشئ الرسائل',
    History: 'السجل',
    'Membership Plan': 'خطة العضوية',
    'Member Progress': 'تقدم العضو',
    'Attendance & Workout': 'الحضور والتمرين',
    'Nutrition Compliance Reports': 'تقارير الامتثال الغذائي',
    'Revenue & Subscription Reports': 'تقارير الإيرادات والاشتراكات',
    'Coach Performance': 'أداء المدرب',
    'Challenge Completion Stats': 'إحصائيات إكمال التحدي'
};