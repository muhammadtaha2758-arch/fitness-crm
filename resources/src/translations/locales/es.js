...
export default {
    ...
    'Nutrition Hub': 'Centro de nutrición',
    Community: 'Comunidad',
    ...
    Support: 'Soporte',
    'Workout Plan Library': 'Biblioteca de planes de entrenamiento',
    'Activity List': 'Lista de actividades',
    'Send Message': 'Enviar mensaje',
    'Sent Messages': 'Mensajes enviados',
    'Email / SMS / App Push Campaigns': 'Campañas de Email / SMS / Push',
    'Automated Messages': 'Mensajes automatizados',
    'WhatsApp / In-App Chat Integration': 'Integración de WhatsApp / Chat en la app',
    'Notifications Manager': 'Administrador de notificaciones',
    'Message Composer': 'Compositor de mensajes',
    History: 'Historial',
    'Membership Plan': 'Plan de membresía',
    'Member Progress': 'Progreso del miembro',
    'Attendance & Workout': 'Asistencia y entrenamiento',
    'Nutrition Compliance Reports': 'Informes de cumplimiento nutricional',
    'Revenue & Subscription Reports': 'Informes de ingresos y suscripciones',
    'Coach Performance': 'Rendimiento del entrenador',
    'Challenge Completion Stats': 'Estadísticas de finalización de desafíos'
};
